...
export const fossilLocations = [
  {
    ...
    visitingInfo: {
      ...
      driving: "Take I-94 west from Billings, then local roads to fossil sites",
      airport: "Billings Logan International Airport (BIL), 2 hours drive",
      bestTime: "May through September for best weather and access",
      contact: "Museum of the Rockies: (406) 994-2251",
    },
  },
  {
    ...
    visitingInfo: {
      ...
      driving: "I-70 west from Denver to Dinosaur National Monument",
      airport: "Denver International Airport (DEN), 4-5 hours drive to monument",
      bestTime: "April through October, avoid winter weather",
      contact: "Dinosaur National Monument: (970) 374-3000",
    },
  },
  {
    id: "gobi-desert",
    ...
    visitingInfo: {
      ...
      driving: "4WD vehicles required, local guides essential",
      airport: "Chinggis Khaan International Airport (UBN), Ulaanbaatar",
      bestTime: "June through August for best weather conditions",
      contact: "Mongolian Natural History Museum: +976-11-325716",
    },
  },
  {
    ...
    visitingInfo: {
      ...
      driving: "A8/E429 from Brussels, well-marked roads",
      airport: "Brussels Airport (BRU), 1 hour drive",
      bestTime: "Year-round, indoor museum exhibits",
      contact: "Royal Belgian Institute: +32-2-627-42-11",
    },
  },
  {
    ...
    visitingInfo: {
      ...
      driving: "4WD required, guided tours recommended from Cairo",
      airport: "Cairo International Airport (CAI), arrange desert expedition",
      bestTime: "October through March for cooler temperatures",
      contact: "Egyptian Geological Museum: +20-2-2794-5815",
    },
  },
  {
    ...
    visitingInfo: {
      ...
      driving: "Route 3 south from Buenos Aires, then local roads",
      airport: "Comodoro Rivadavia Airport (CRD), closest to fossil sites",
      bestTime: "November through March (Southern Hemisphere summer)",
      contact: "Museo Argentino: +54-11-4982-6595",
    },
  },
  {
    ...
    visitingInfo: {
      ...
      driving: "A2 highway from Amsterdam or Brussels, well-connected",
      airport: "Maastricht Aachen Airport (MST) or Amsterdam Schiphol (AMS)",
      bestTime: "Year-round, underground sites and museums",
      contact: "Natuurhistorisch Museum: +31-43-350-5490",
    },
  },
]
